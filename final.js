...
loader.load('../final_project/model/RobotExpressive.glb', function (gltf) {
    model = gltf.scene;
...
loader_2.load('../final_project/model/uploads_files_3076931_medieval_door/scene.gltf', function (gltf) {
...
loader_3.load('../final_project/model/scifi_button/scene.gltf', function (gltf) {
...
loader_4.load('../final_project/model/lightning_capsule/scene.gltf', function (gltf) {
...
document.addEventListener('mousedown', () => {
    ...
    if (open_sign == 1) {
        ...
        switch (sign_context) {
            case 1: url = '../final_project/texture/sign_context/level1.png';break;
            case 2: url = '../final_project/texture/sign_context/level2.png';break;
            case 3: url = '../final_project/texture/sign_context/level3.png';break;
        }
        //load pic
...
//conversation
const pics_url = '../final_project/texture/conversation/'
